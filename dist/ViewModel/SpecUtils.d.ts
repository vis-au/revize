...
export declare function getJoinedDatasetsOfChildNodes(template: View): Datasets;
export declare function getAllDatasetsInHierarchy(template: View): import("vega-lite/build/src/util").Dict<import("vega-lite/build/src/data").InlineDataset>;
